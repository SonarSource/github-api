...
public class PullRequestTest extends AbstractGitHubApiTestBase {
    ...
    private static final Property ORGANIZATION_PROPERTY = new Property("github_api_organization", "github-api-test");
    private static final Property REPOSITORY_PROPERTY = new Property("github_api_pr_repository", "jenkins");
